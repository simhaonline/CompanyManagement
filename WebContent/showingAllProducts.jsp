...
prodlist=(ArrayList<Product>) request.getAttribute("prodlist");
...
<td>
<%=p.getInventory().getProdModel().getModelid() %>	
</td>
<td>
<%=p.getInventory().getProdModel().getModelName() %>
</td>
<td>
<%=p.getInventory().getStore().getStorename() %>
</td>
</tr>
<%
}
