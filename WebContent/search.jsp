...
<div class="info">
  <h1>Search Bill</h1>
  <br>
  <%ArrayList<String> stlist=(ArrayList<String>)request.getAttribute("list"); %>
<form name="bill" method="get" action="Billmanager" >

<tr>
	<td><h2>Bill Id</h2></td>
   <td> <select name="billid" required class="ghost_button">
...
<%} %>
      ...
      <input type="hidden" name="fun" value="searchbill">
     <input type="submit" name="submit" value="Search" class="ghost_button">
