...
tree=(ArrayList<ProductModel>) request.getAttribute("tree");
for(ProductModel model:tree){
	%>
	<td>
	<%=model.getModelid() %>
	</td>
	...
	<input type="hidden" name="pmid" value="<%=model.getModelid() %>">
	...
	<input type="hidden" name="pmid" value="<%=model.getModelid() %>">
      <input type="hidden" name="fun" value="deleteprod">
