...
<tr>
	<td>Last Name :</td>
   <td><input type="Textbox" name="lname" id="lastname"   onkeyup="return validate_lastname()"></td>
...
<tr>
	...
	<td> <span id="genderChange" style="color:red"></span></td>
</tr>
...
<tr>
	<td>Role :</td>
    <td> <select name="role" required onchange="if (this.value=='Manager'){this.form['store'].style.visibility='visible';this.form['region'].style.visibility='visible'}else {this.form['store'].style.visibility='hidden';this.form['region'].style.visibility='hidden'};">
...
<tr>
	<td>Store</td>
    <td>  <select name ="store" id ="store"></select></td> 
 <script language="javascript">
populateCountries("region", "store");
</script>
...
<tr>
	 ...
	 <input type="hidden" name="fun" value="addemployee">
